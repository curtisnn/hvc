...
<template>
  <div class="relative bg-gray-50 mb-12">
    <main class="lg:relative pt-5">
      ...
      <div class="w-full max-w-7xl lg:text-left mx-auto py-16">
        <!-- <div class="flex">
          <div class="w-1/3">
            <div class="relative mt-1 rounded-md shadow-sm">
              ...
              <input
                ...
                name="search"
                id="search"
                class="block w-full rounded-sm border border-gray-400 py-1 pl-10 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                placeholder="Search..."
              />
            </div>
          </div>
        ...
        <div v-if="state" class="mt-6">
          ...
          <div
            class="overflow-hidden bg-white sm:rounded-md border border-gray-200 max-w-4xl"
          >
                        ...
                        <div class="hidden md:block">
                          <div>
                            ...
                            <p class="text-xs text-gray-400" v-else>
                              credentialing provider unknown
                            </p>
                            <p
