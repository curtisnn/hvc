        ...
        <div class="max-w-4xl container lg:text-left mx-auto py-6 px-44">
          ...
          >
            <div class="w-1/3 px-4">
              ...
              <div class="flex items-center w-full pl-6">
                <div class="relative">
                  <input
                    type="text"
                    v-model="query"
                    name="search"
                    id="search"
                    class="block w-96 border-b border-gray-400 pt-2 px-3 focus:border-b focus:border-indigo-500 text-gray-600 sm:text-base"
                    placeholder="Search..."
                  />
                </div>
                <div class="flex-1 pl-2 text-gray-500 text-sm">
                  <button @click="clearQuery()" v-if="query">clear</button>
                </div>
              </div>
            </div>
            <!-- <div class="w-1/4">
              ...
              <select
                ...
                @select="getState(e)"
                name="location"
                class="mt-1 block w-full bg-white border-b border-gray-400 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
              >
                <option selected value=""></option>
                <option v-for="state in allStates" :value="state" :id="state">
                  {{ state }}
                </option>
              </select>
            </div> -->
      ...
      <div v-if="states && result" class="mt-6 container mx-auto">
        <!-- <div class="flex space-x-3 mb-5">
          <div
            ...
            class="capitalize px-2 py-1 bg-blue-100 border border-blue-200 w-36 rounded-md text-blue-800 flex items-center justify-between"
          >
            {{ state.replace("-", " ") }}
            <button
        ...
        <div class="mb-6 max-w-4xl mx-auto">
          <div class="text-gray-400 text-sm font-light mb-3">
            total results: {{ result.hits.length }}
          </div>
          <div
            class="capitalize font-bold text-lg flex items-center"
            v-if="state.length > 0"
          >
            {{ state.replace("-", " ") }}
            <button
              @click="removeState()"
              class="text-blue-500 hover:text-blue-600 bg-blue-200 px-1 py-1 ml-3"
            >
              <svg
                class="w-6 h-6"
                fill="none"
